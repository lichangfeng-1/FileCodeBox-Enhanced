export default {
  ...
  admin: {
    ...
    webhook: {
      ...
      test: 'Send Test',
      delete: 'Delete',
      confirmDelete: 'Delete this webhook configuration?',
      save: 'Save',
      cancel: 'Cancel',
      empty: 'No webhook configurations',
      logs: 'Delivery Logs',
      status: 'Status',
      result: 'Result'
    },
    settings: {
      ...
      loginMaxAttempts: 'Max Failed Attempts (lock after exceeding, min 3)',
      loginLockMinutes: 'Lock Duration (minutes, min 5)',
      times: 'times',
  ...
  fileManage: {
    ...
    dedupType: 'Dedup',
    uniqueType: 'Unique',
    dedupBadgeTitle: 'This file shares identical content with other files (deduplicated)',
    healthFilters: {
      all: 'All',
