export default {
  ...
  admin: {
    ...
    audit: {
      ...
      ipPlaceholder: '按 IP 筛选',
      keywordPlaceholder: '按文件名搜索'
    },
    webhook: {
      title: 'Webhook 通知',
      create: '新建',
      ...
      test: '发送测试',
      delete: '删除',
      confirmDelete: '确定删除该 Webhook 配置？',
      save: '保存',
      cancel: '取消',
      empty: '暂无 Webhook 配置',
      logs: '发送日志',
    ...
    settings: {
      ...
      loginSecurity: '登录安全',
      loginMaxAttempts: '允许失败次数（超过后锁定，最低 3）',
      loginLockMinutes: '锁定时长（分钟，最低 5）',
      times: '次',
      saveChanges: '保存设置',
      fileSizeUnits: {
        kb: 'KB',
  ...
  fileManage: {
    ...
    dedupType: '秒传',
    uniqueType: '非秒传',
    dedupBadgeTitle: '该文件与其他文件共享相同内容（秒传去重）',
    healthFilters: {
      all: '全部',
      attention: '需关注',
      danger: '异常',
